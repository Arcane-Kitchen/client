...
const Login: React.FC = () => {
  ...
  return (
    ...
    >
      <div 
        className="p-4 flex items-center justify-center bg-[url('/input_field.png')] bg-contain bg-center w-full md:bg-[url('/sign-up-box.svg')] md:bg-cover lg:bg-cover lg:w-3/5"
        style={{
